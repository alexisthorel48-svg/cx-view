...
(async()=>{const q=s=>pool.query(s);try{
...
await q(`CREATE INDEX IF NOT EXISTS idx_cx_screens_client ON cx_screens(client_id)`);
...
console.log('Migration V0.7/V0.8 terminée');
