    ...
    try {
      ...
      const config = {
        ...
        screen: {
          ...
          zone_a_crop_top: asNumber(screen.zone_a_crop_top),
          zone_a_crop_right: asNumber(screen.zone_a_crop_right),
          zone_a_crop_bottom: asNumber(screen.zone_a_crop_bottom),
          zone_a_crop_left: asNumber(screen.zone_a_crop_left),
          zone_a_crop_mode: screen.zone_a_crop_mode || 'HIDE',
          zone_b_crop_top: asNumber(screen.zone_b_crop_top),
          zone_b_crop_right: asNumber(screen.zone_b_crop_right),
          zone_b_crop_bottom: asNumber(screen.zone_b_crop_bottom),
          zone_b_crop_left: asNumber(screen.zone_b_crop_left),
          zone_b_crop_mode: screen.zone_b_crop_mode || 'HIDE',
